...
export class RxLet<U> implements OnInit, OnChanges, OnDestroy {
   ...
   */
  @Input()
  set rxLet(potentialObservable: ObservableInput<U>) {
  ...
  @Input('rxLetCompleteTrg') completeTrigger?: Observable<any>;

  @Input('rxLetErrorTrg') errorTrigger?: Observable<any>;

  @Input('rxLetSuspenseTrg') suspenseTrigger?: Observable<any>;

  @Input('rxLetNextTrg') nextTrigger?: Observable<any>;
  ...
  ngOnInit() {
    ...
    this.subscription.add(
      merge(
        this.nextTrigger
          ? this.nextTrigger.pipe(map(() => RxNotificationKind.Next))
          : NEVER,
        this.suspenseTrigger
        ...
        this.completeTrigger
          ...
          : NEVER,
        this.errorTrigger
          ? this.errorTrigger.pipe(map(() => RxNotificationKind.Error))
          : NEVER
